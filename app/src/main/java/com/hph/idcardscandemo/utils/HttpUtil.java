package com.hph.idcardscandemo.utils;
...
public class HttpUtil {
    ...
    public static final String USERNAME = "dff51425-e55a-4d5b-a46b-447e13100ba0";//开发者平台API帐号
    public static final String PASSWORD = "ZsNwcoisZURidwQxTlleGHKawkkwxN";//开发者平台API密码
